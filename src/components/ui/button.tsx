...
const buttonVariants = cva(
  "inline-flex h-10 items-center justify-center gap-2 rounded-lg px-4 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-glow hover:-translate-y-0.5 hover:shadow-lg",
        secondary: "bg-muted text-foreground hover:bg-muted/80",
        ghost: "hover:bg-muted/70",
        outline: "border border-border bg-background/60 hover:bg-muted/60",
        glass: "border border-border bg-muted/50 text-foreground hover:bg-muted/80"
      },
      size: {
        sm: "h-8 px-3 text-xs",
        md: "h-10 px-4",
